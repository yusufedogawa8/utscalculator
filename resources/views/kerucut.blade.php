...
<h3 class="text-center text-uppercase mt-5 mb-5">Menghitung bangun ruang kerucut</h3>
    <div class="container justify-content-center col-4">
        <h3 class="text-center font-weight-light mb-3">Volume Kerucut</h3>
        <form method="POST" action="/calculatekerucut">
            {{ csrf_field() }}
            ...
            <div class="input-group justify-content-center">
                <a class="btn btn-danger mt-3" href="/kerucut">Reset</a>
